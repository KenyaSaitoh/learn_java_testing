...
PUBLISHER_ID   INT AUTO_INCREMENT PRIMARY KEY, -- 出版社番号
PUBLISHER_NAME VARCHAR(30) NOT NULL            -- 出版社名
);

CREATE TABLE CATEGORY (
CATEGORY_ID   INT AUTO_INCREMENT PRIMARY KEY, -- カテゴリ番号
CATEGORY_NAME VARCHAR(20) NOT NULL            -- カテゴリ名
);

CREATE TABLE BOOK (
BOOK_ID      INT AUTO_INCREMENT PRIMARY KEY, -- 書籍番号
...
CUSTOMER_ID   INT AUTO_INCREMENT PRIMARY KEY, -- 顧客番号
...
ORDER_TRAN_ID    INT AUTO_INCREMENT PRIMARY KEY, -- 注文取引番号
...
ORDER_TRAN_ID   INT NOT NULL, -- 注文取引番号
